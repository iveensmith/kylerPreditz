...
const DEFAULT_BLURB =
  "Statistical football predictions, match analysis, and a public results archive — built on a Poisson/Dixon–Coles goals model driven by each team's recent home and away form.";
const DEFAULT_DISCLAIMER =
  "Predictions on this site are statistical estimates generated by our model, not guaranteed outcomes. Betting involves risk - never stake more than you can afford to lose. If you or someone you know has a gambling problem, help is available.";

export async function Footer() {
  const content = await getSiteContent();
  const quickLinks = [...QUICK_LINKS, ...content.extraFooterLinks];
  return (
    <footer className="mt-auto border-t border-white/10 bg-[#08110D] text-white/55">
      <div className="mx-auto max-w-6xl px-4 py-14 sm:px-6">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="mx-auto mt-4 max-w-md text-sm leading-relaxed">{content.footerBlurb || DEFAULT_BLURB}</p>
        </div>
        ...
        <div className="mt-12 flex flex-col gap-3 border-t border-white/10 pt-8 text-xs">
          ...
          <p className="leading-relaxed">{content.footerDisclaimer || DEFAULT_DISCLAIMER}</p>
          <p>
